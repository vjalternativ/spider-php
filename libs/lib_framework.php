...
class lib_framework
{
    ...
    function execute()
    {
        ...
        if (isset($_GET['module']) && isset($_GET['action'])) {
            ...
            $vjconfig = \lib_config::getInstance()->getConfig();
            if (isset($vjconfig['init_default_modules']) && (! array_key_exists("disabledb", $vjconfig) || ! $vjconfig['disabledb'])) {
                $this->initModules();
            }
            ...
            if (! empty($controller->view)) {
                ...
                if (file_exists($filepath)) {
                    ...
                    $filepath = $vjconfig['basepath'] . 'resources/' . $this->resource . '/modules/' . $this->module . '/views/' . $this->module . 'View' . ucfirst($controller->view) . '.php';
                    if (file_exists($filepath)) {
                        $class = $this->module . 'View' . ucfirst($controller->view);
                    } else {
