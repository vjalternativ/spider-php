! function(e) {
        ...
        js.Boot = function() {}, js.Boot.__name__ = !0, js.Boot.__unhtml = function(e) {
            ...
            switch ("function" == n && (e.__name__ || e.__ename__) && (n = "object"), n) {
                case "object":
                    ...
                    for (var d in e) m && !e.hasOwnProperty(d) || "prototype" != d && "__class__" != d && "__super__" != d && "__interfaces__" != d && "__properties__" != d && (2 != i.length && (i += ", \n"), i += t + d + " : " + js.Boot.__string_rec(e[d], t));
                    return i += "\n" + (t = t.substring(1)) + "}";
                case "function":
                    return "<function>";
                case "string":
    ...
    function u(e, t) {
        for (var n = 0; n < e.length; n++) {
            ...
            if (a) {
                ...
                var s = [];
                for (o = 0; o < r.parts.length; o++) s.push(f(r.parts[o], t));
                i[r.id] = {
                    id: r.id,
                    refs: 1,
                    parts: s
    ...
    function f(e, t) {
        ...
        if (t.singleton) {
            var l = s++;
            n = o || (o = g(t)), i = _.bind(null, n, l, !1), r = _.bind(null, n, l, !0)
        } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = function(e) {
            var t = document.createElement("link");
            return void 0 === e.attrs.type && (e.attrs.type = "text/css"), e.attrs.rel = "stylesheet", p(t, e.attrs), m(e, t), t
        }(t), i = function(e, t, n) {
            var i = n.css,
                r = n.sourceMap,
    ...
    var o = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(e) {
                ...
                e = (e = (e = (e = (e = e.split(t).join(r.xmlCharacters.tagOpener)).split(n).join(r.xmlCharacters.tagCloser)).split(i).join(r.xmlCharacters.doubleQuote)).split(c).join(r.xmlCharacters.ampersand)).split(u).join(r.xmlCharacters.quote);
                for (var d = "", m = null, h = 0; h < e.length; h += 1) {
                    var g = e.charAt(h);
                    null == m ? "$" === g ? m = "" : d += g : ";" === g ? (d += "&".concat(m), m = null) : g.match(/([a-zA-Z0-9#._-] | '-')/) ? m += g : (d += "$".concat(m), m = null, h -= 1)
                }
                return d
            }
        }, {
            ...
            value: function(t, n, i) {
                ...
                if (-1 !== t.indexOf("<annotation")) {
                    ...
                    var c = t.indexOf(">") + 1,
                        ...
                        d = t.substring(c, u);
                    r = "".concat(t.substring(0, c), "<semantics>").concat(d, '<annotation encoding="').concat(i, '">').concat(n, "</annotation></semantics></math>")
                }
                return r
            }
        }, {
            ...
            value: function(t, n) {
                var i = t,
                    ...
                    a = t.indexOf(r);
                if (-1 !== a) {
                    for (var o = !1, s = t.indexOf("<annotation"); - 1 !== s;) s !== a && (o = !0), s = t.indexOf("<annotation", s + 1);
                    if (o) {
                        var l = t.indexOf("</annotation>", a) + "</annotation>".length;
            ...
            value: function(e) {
                for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : r.xmlCharacters, n = "".concat(t.tagOpener, "math"), i = "".concat(t.tagOpener, "/math").concat(t.tagCloser), a = "/".concat(t.tagCloser), o = t.tagCloser, s = "".concat(t.tagOpener, "semantics").concat(t.tagCloser), l = "".concat(t.tagOpener, "annotation encoding="), c = "", u = e.indexOf(n), d = 0; - 1 !== u;) {
                    c += e.substring(d, u);
                    var m = e.indexOf(i, u),
                        h = e.indexOf(a, u),
                        g = e.indexOf(o, u); - 1 !== m ? d = m : h === g - 1 && (d = h);
                    var p = e.indexOf(s, u);
                    if (-1 !== p) {
                        ...
                        if (-1 !== v) {
                            var _ = p + s.length;
                            c += f + e.substring(_, v) + i, u = e.indexOf(n, u + n.length), d += i.length
    ...
    var f = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(t, n) {
                ...
                if ("ok" === s.status) {
                    var l = s.result.text;
                    a = -1 === (l = l.split("\r").join("").split("\n").join(" ")).indexOf("semantics") && -1 === l.indexOf("annotation") ? l = o.addAnnotation(l, t, "LaTeX") : l, i.get(t) || i.populate(t, l)
                } else a = "$$".concat(t, "$$");
                return a
            }
        }, {
            ...
            value: function(t, n) {
                for (var i, a, s, l = "", c = "".concat(n.tagOpener, "math"), u = "".concat(n.tagOpener, "/math").concat(n.tagCloser), d = "".concat(n.tagOpener, "annotation encoding=").concat(n.doubleQuote, "LaTeX").concat(n.doubleQuote).concat(n.tagCloser), m = "".concat(n.tagOpener, "/annotation").concat(n.tagCloser), h = t.indexOf(c), g = 0; - 1 !== h;) {
                    if (l += t.substring(g, h), -1 === (g = t.indexOf(u, h)) ? g = t.length - 1 : g += u.length, -1 !== (a = (i = t.substring(h, g)).indexOf(d))) {
                        a += d.length, s = i.indexOf(m);
            ...
            value: function(t, n, i) {
                ...
                if (u) {
                    var d = r.ch,
                        m = r.cb,
                        h = r.dpi;
                    h && (u = 96 * u / h, d = 96 * d / h, m = 96 * m / h), t.width = u, t.height = d, t.style.verticalAlign = "-".concat(d - m, "px")
                }
            }
        }, {
            key: "fixAfterResize",
        ...
        return function(e, t, n) {
            ...
            value: function(t, n, i, r) {
                ...
                if (!l.get("wirisPluginPerformance") || "xml" !== l.get("saveMode") && "safeXml" !== l.get("saveMode")) {
                    ...
                    a.setAttribute(l.get("imageMathmlAttribute"), o.safeXmlEncode(n)), a.src = u, k.setImgSize(a, u, "base64" === l.get("saveMode") && "default" === l.get("base64savemode")), l.get("enableAccessibility") && (a.alt = C.mathMLToAccessible(n, r, s))
                } else {
                    ...
                    "png" === (d = d.result).format ? a.src = "data:image/png;base64,".concat(d.content) : a.src = "data:image/svg+xml;charset=utf8,".concat(w.urlEncode(d.content)), a.setAttribute(l.get("imageMathmlAttribute"), o.safeXmlEncode(n)), k.setImgSize(a, d.content, !0), l.get("enableAccessibility") && (void 0 === d.alt ? a.alt = C.mathMLToAccessible(n, r, s) : a.alt = d.alt)
                }
                    ...
                    for (var t = w.getElementsByNameFromString(e, "img", !0), n = 'encoding="LaTeX">', i = 0, r = 0; r < t.length; r += 1) {
                        ...
                        if (-1 !== a.indexOf(' class="'.concat(l.get("imageClassName"), '"'))) {
                            ...
                            if (-1 === c && (s = ' alt="', c = a.indexOf(s)), -1 !== c) {
                                c += s.length;
                                var u = a.indexOf('"', c),
                                    d = o.safeXmlDecode(a.substring(c, u)),
                                    m = d.indexOf(n);
                                if (-1 !== m) {
                                    m += n.length;
                                    ...
                                    e = e.substring(0, t[r].start + i) + p + e.substring(t[r].end + i), i += p.length - (t[r].end - t[r].start)
                                }
                            }
                        }
                    }
            ...
            value: function(t, n) {
                for (var i = "", r = 0, a = /<img/gi, s = a.source.length; a.test(t);) {
                    ...
                    else if ("img2mathml" === n) l.get("saveMode") && ("safeXml" === l.get("saveMode") ? (f = !0, v = !0) : "xml" === l.get("saveMode") && (f = !0, v = !1)), i += w.getWIRISImageOutput(h, f, v);
                    else if ("img264" === n) {
                        null === p && (p = g.getAttribute("alt")), p = o.safeXmlDecode(p);
                        var _ = {
                            base64: "true"
                        };
                        h = e.mathmlToImgObject(document, p, _, null), k.setImgSize(h, h.src, !0), i += w.createObjectCode(h)
                    }
                }
            ...
            value: function(t, n, i) {
                for (var a = "", s = "".concat(n.tagOpener, "math"), c = "".concat(n.tagOpener, "/math").concat(n.tagCloser), u = t.indexOf(s), d = 0; - 1 !== u;) {
                    a += t.substring(d, u);
                    var m = t.indexOf(l.get("imageMathmlAttribute"));
                    if (-1 === (d = t.indexOf(c, u)) ? d = t.length - 1 : d += -1 !== m ? t.indexOf("/>", u) : c.length, o.isMathmlInAttribute(t, u) || -1 !== m) a += t.substring(u, d);
                    else {
    ...
    if ("undefined" != typeof MutationObserver) {
        ...
        T.observer = Object.create(E), T.observer.Config = {
            attributes: !0,
            attributeOldValue: !0
    ...
    var I = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(e) {
                ...
                return "".concat(e.protocol, "//").concat(e.hostname).concat(t ? "" : ":" + e.port).concat(e.pathname.startsWith("/") ? e.pathname : "/" + e.pathname)
            }
        }, {
            key: "isIOS",
            value: function() {
    ...
    var F = function() {
        ...
        R = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto) || "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues && msCrypto.getRandomValues.bind(msCrypto),
        U = new Uint8Array(16);
    ...
    for (var H = function(e) {
        ...
        }, W = [], V = 0; V < 256; ++V) W.push((V + 256).toString(16).substr(1));
    var J = function(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
            n = (W[e[t + 0]] + W[e[t + 1]] + W[e[t + 2]] + W[e[t + 3]] + "-" + W[e[t + 4]] + W[e[t + 5]] + "-" + W[e[t + 6]] + W[e[t + 7]] + "-" + W[e[t + 8]] + W[e[t + 9]] + "-" + W[e[t + 10]] + W[e[t + 11]] + W[e[t + 12]] + W[e[t + 13]] + W[e[t + 14]] + W[e[t + 15]]).toLowerCase();
    ...
    var q = function() {
            ...
            return function(e, t, n) {
                ...
                get: function() {
                    if (!this._senderId) {
                        ...
                        this._senderId || (this._senderId = e.composeUUID(), document.cookie = this.composeCookie(Z, this._senderId, G))
                    }
        ...
        Z = "wiris_telemetry_mathtype_web_senderid",
        G = 31536e4;
    ...
    q.endpoint = "https://telemetry.wiris.net", q._senderId = "", q._sessionId = "";
    var ee = function() {
        function e(t) {
            var n = this;
            if (function(e, t) {
        ...
        return function(e, t, n) {
            ...
            value: function() {
                ...
                var s = {};
                s.serviceProviderProperties = this.serviceProviderProperties, this.setCore(new ge(s)), this.core.addListener(t), this.core.language = this.language, this.core.init(), this.core.setEnvironment(this.environment)
            }
        }, {
            key: "getPath",
            value: function() {
    ...
    var me = function() {
        function e(t) {
            ...
            this.popup = new F(_), this.rtl = !1, "rtl" in this.attributes && (this.rtl = this.attributes.rtl), this.handleOpenedIosSoftkeyboard = this.handleOpenedIosSoftkeyboard.bind(this), this.handleClosedIosSoftkeyboard = this.handleClosedIosSoftkeyboard.bind(this)
        }
        return de(e, [{
            ...
            value: function(e, t) {
                return new(function() {
                    function n() {
                        ce(this, n), this.element = document.createElement("button"), this.element.id = e.id, this.element.className = e.class, this.element.innerHTML = e.innerHTML, w.addEvent(this.element, "click", t)
                    }
                    return de(n, [{
                        key: "getElement",
                        value: function() {
            ...
            key: "close",
            value: function() {
                ee.setTemporalImageToNull(), this.removeClass("wrs_maximized"), this.removeClass("wrs_minimized"), this.removeClass("wrs_stack"), this.addClass("wrs_closed"), this.saveModalProperties(), this.unlockWebsiteScroll(), this.properties.open = !1
            }
        }, {
    ...
    var ge = function() {
        function e(t) {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.language = "en", this.editMode = "images", this.modalDialog = null, this.customEditors = new z;
            if (this.customEditors.addEditor("chemistry", {
                ...
                }(), this.listeners = new m, this.serviceProviderProperties = {}, !("serviceProviderProperties" in t)) throw new Error("serviceProviderProperties property missing.");
        ...
        return function(e, t, n) {
                ...
                if (e.initialized) this.listeners.fire("onLoad", {});
                    ...
                    var n = m.newListener("onInit", function() {
                        var e = g.getService("configurationjs", "", "get"),
                            n = JSON.parse(e);
                        l.addConfiguration(n), l.addConfiguration(L), b.language = t.language, t.listeners.fire("onLoad", {})
                    });
            ...
            value: function(e, t, n, i) {
                ...
                if (n)
                    ...
                    } else r.node = T.mathmlToImgObject(t.document, n, i, this.language), this.insertElementOnSelection(r.node, e, t);
            ...
            value: function(e, t) {
                        ...
                        if (!n.caretPosition && w.containsClass(n.node, l.get("imageClassName"))) this.editionProperties.temporalImage = n.node, this.editionProperties.isNewElement = !1;
                            ...
                            if (this.integrationModel.getMathmlFromTextNode) {
                                ...
                                if (c) {
                                    ...
                                    this.editMode = "latex", this.editionProperties.isNewElement = !1, this.editionProperties.temporalImage = document.createElement("img"), this.editionProperties.temporalImage.setAttribute(l.get("imageMathmlAttribute"), o.safeXmlEncode(u));
                                    ...
                                    if ("textarea" !== e.tagName.toLowerCase())
                                        if (document.selection) {
                                            ...
                                            this.editionProperties.latexRange = d.document.selection.createRange(), this.editionProperties.latexRange.moveToElementText(c.startNode.parentNode), this.editionProperties.latexRange.move("character", h + c.startPosition), this.editionProperties.latexRange.moveEnd("character", c.latex.length + 4)
                ...
                for (var p = l.get("editorAttributes").split(", "), v = {}, _ = 0, b = p.length; _ < b; _ += 1) {
                    var y = p[_].split("="),
                        x = y[0],
                        k = y[1];
                    v[x] = k
                ...
                Object.assign(A, v, C), Object.assign(A, v, M), A.language = this.language, A.rtl = this.integrationModel.rtl;
                var T = {};
                if (T.editorAttributes = A, T.language = this.language, T.customEditors = this.customEditors, T.environment = this.environment, null == this.modalDialog) {
                    this.modalDialog = new me(A), this.contentManager = new I(T);
    ...
    ge._globalListeners = new m, ge._initialized = !1;
    ...
    var xe = function(e) {
        ...
        function n(e) {
            ...
            return function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, n), (i = t.call(this, e)).integrationFolderName = "ckeditor_wiris", i
        }
        return function(e, t, n) {
            ...
            value: function() {
                ...
                return null != this.editorObject.langCode ? this.editorObject.langCode : _e(we(n.prototype), "getLanguage", this).call(this)
            }
        }, {
            key: "getPath",
            value: function() {
            ...
            value: function() {
                ...
                void 0 !== e.config.wirislistenersdisabled && e.config.wirislistenersdisabled ? (e.on("instanceReady", function(e) {
                    this.checkElement()
                }.bind(this)), e.resetDirty()) : (e.setData(T.initParse(e.getData())), e.on("focus", function(e) {
                    ...
                    void 0 !== T.observer && Array.prototype.forEach.call(document.getElementsByClassName("Wirisformula"), function(e) {
            ...
            value: function() {
                ...
                if (!(e = t.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? t.container.$ : n.getElementsByTagName("iframe")[0])) {
                    ...
                    r && (i = !0, (e = document.getElementById(r + "_contents")).wirisActive = !1)
                }
                if (!e.wirisActive)
            ...
            value: function(e, t, i, r) {
                var a = _e(we(n.prototype), "insertFormula", this).call(this, e, t, i, r);
                return this.editorObject.fire("change"), a
            }
        }, {
            key: "getCorePath",
            value: function() {
            ...
            key: "callbackFunction",
            value: function() {
                _e(we(n.prototype), "callbackFunction", this).call(this), this.addEditorListeners()
            }
        }]), n
    }();
