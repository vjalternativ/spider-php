function autocomplete(inp, obj,key_element_id=false) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      if(key_element_id) {
    	  key = document.getElementById(key_element_id).value;
    	  arr = obj[key];
      } else {
    	  arr = obj;
      }
  ...
  inp.addEventListener("keydown", function(e) {
      ...
      if (e.keyCode == 40) {
        ...
        currentFocus++;
        console.log("current focus down ",currentFocus);;
  ...
  function addActive(x) {
    ...
    try {
    	...
    	console.log("class list is undefined for "+ currentFocus );
