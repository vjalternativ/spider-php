...
function generatePanel($heading = "",$panelbody="",$panelfooter="",$class = "info",$id="") {
		...
		$panel = array();
		$panel['elem'] ='div';
		$panel['attr'] = array("class"=>'panel panel-'.$class,"id"=>$id);
		
		$panel['contents'][] = $panelheading;
		
		if($panelbody) {
		    $panelBodyEle = array();
		    $panelBodyEle['div']['attr'] = array("class"=>'panel-body');
...
function panel($headingcontent,$bodycontent,$footercontent) {
	...
	$heading = $bs->getelement('div',$headingcontent,array('class'=>'panel-heading'));
	$body = $bs->getelement('div',$bodycontent,array('class'=>'panel-body'));
	$footer = $bs->getelement('div',$footercontent,array('class'=>'panel-heading'));
