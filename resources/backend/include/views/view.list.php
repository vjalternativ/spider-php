...
class ViewList extends BackendResourceView
{
    ...
    function __construct()
    {
        ...
        $this->listview['tpl'] = $vjconfig['fwbasepath'] . 'resources/backend/include/tpls/listview.tpl';
        $this->listview['tpls']['filter']['varchar'] = $vjconfig['fwbasepath'] . 'resources/backend/include/tpls/filters/varchar.tpl';
    }
    ...
    function display()
    {
        ...
        $addnew = $bs->getelement('a', 'Add New ' . $module, array(
            'href' => array(
                'value' => $href
            ),
            'class' => array(
        ...
        $editbutton = $bs->getelement('a', 'Edit', array(
            'href' => $url,
            'class' => 'btn btn-info'
        ));
        $url = "index.php?module=" . $this->module . "&action=detailview&record=RID";
        $detailbutton = $bs->getelement('a', 'Detail', array(
            'href' => $url,
            'class' => 'btn btn-primary'
        ));
        $deletebutton = $bs->getelement('button', 'X', array(
            'class' => 'btn btn-danger',
            'onclick' => "deleteRecord('ROWID','" . $this->module . "','RID')"
        ));
