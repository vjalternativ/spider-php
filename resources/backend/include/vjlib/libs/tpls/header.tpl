...
{$css}
{/foreach}
<link rel="stylesheet" href="{$fwbaseurl}assets/font-awesome/css/font-awesome.min.css" />
<link rel="stylesheet" href="{$fwbaseurl}assets/css/jquery-ui.css" />
<link rel="stylesheet" href="{$fwbaseurl}assets/css/jquery-ui.css" />

<link rel="stylesheet" href="{$fwbaseurl}assets/css/bootstrap-datetimepicker.css" />

<script src="{$fwbaseurl}assets/js/jquery-3.1.1.min.js"></script>
