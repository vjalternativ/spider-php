...
/*	
	...
	*/
	...
	function saveIntoDB($table,$keyvalue,$where=false,$return = false) {
	    ...
	    global $vjlib,$logicHook,$globalModuleList,$globalLogicHook,$vjconfig;
	    $isnew = false;
		$sql = "UPDATE ";
	...
	public function generateCache() {
	    ...
	    $globalServerPrefenreceStoreList = $db->fetchRows("select * from server_preference_store where deleted=0",array("name"),false,false);
