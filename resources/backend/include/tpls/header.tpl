...
<script src="{$fwbaseurl}thirdparty/client/ckeditor/plugins/ckeditor_wiris/editor.js"></script>
<script src="{$fwbaseurl}thirdparty/client/ckeditor/plugins/ckeditor_wiris/plugin_latest.js"></script>
