...
class tableinfoLogicHook
{
    ...
    function fixDef($keyvalue)
    {
        ...
        $keyvalue['editviewdef'] = json_encode($this->tableinfoService->fixGridDef($editview));
        $keyvalue['detailviewdef'] = json_encode($this->tableinfoService->fixGridDef($detailview));
